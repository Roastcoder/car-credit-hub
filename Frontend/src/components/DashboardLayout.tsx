...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    path: '/leads-list',
    icon: UserPlus,
    roles: ['super_admin', 'admin', 'manager', 'rbm', 'pdd_manager', 'employee'],
    children: [
  ...
  { title: 'Loan Applications', path: '/loans', icon: FileText, roles: ['super_admin', 'admin', 'manager', 'rbm', 'pdd_manager', 'bank', 'broker', 'employee'] },
  { title: 'Create Loan', path: '/loans/new', icon: Car, roles: ['super_admin', 'admin', 'manager', 'pdd_manager', 'employee'] },
  { title: 'PDD Tracking', path: '/pdd-tracking', icon: ClipboardCheck, roles: ['super_admin', 'admin', 'manager', 'pdd_manager', 'employee'] },
  { title: 'Payments', path: '/payments', icon: Wallet, roles: ['super_admin', 'admin', 'manager', 'rbm', 'pdd_manager', 'employee'] },
  { title: 'Reports', path: '/reports', icon: BarChart3, roles: ['super_admin', 'admin', 'manager', 'rbm', 'pdd_manager'] },
