...
import { ArrowLeft, ArrowRight, ChevronLeft, ChevronRight, User, Car, IndianRupee, Building2, FileText, Eye, X, Printer, MessageCircle, Mail, Download, ExternalLink, MessageSquare, MapPin, Clock, CreditCard, Trash2, Camera, Upload, CheckCircle2, ShieldCheck, Edit2, RefreshCw, AlertTriangle } from 'lucide-react';
...
export default function LoanDetail() {
  ...
  // Allow edit if not submitted, OR if user is admin/pdd_manager (they can edit anytime)
  const canEditPDD = baseCanEditPDD && (!isPDDSubmitted || user?.role === 'admin' || user?.role === 'super_admin' || user?.role === 'pdd_manager');
