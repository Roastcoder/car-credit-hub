  ...
  const steps = [
    {
      ...
      completed: ['submitted', 'manager_review', 'manager_approved', 'admin_approved', 'disbursed'].includes(currentStatus),
    ...
    },
    {
      ...
      completed: ['manager_review', 'manager_approved', 'admin_approved', 'disbursed'].includes(currentStatus),
    ...
    },
    {
      ...
      completed: ['manager_approved', 'admin_approved', 'disbursed'].includes(currentStatus),
      current: currentStatus === 'manager_approved',
    ...
    },
    {
      ...
      current: currentStatus === 'admin_approved' || currentStatus === 'approved',
      icon: CheckCircle,
    },
    {
      id: 'disbursed',
