          ...
          <div className="bg-white dark:bg-slate-800/80 rounded-2xl shadow-xl shadow-black/[0.04] border border-slate-200/70 dark:border-slate-700/50 p-7 sm:p-8">
            ...
            {!isStandalone && (
              <a
                href="/mehar-finance.apk"
                download
                className="lg:hidden w-full flex items-center justify-center gap-2 bg-blue-600 text-white font-semibold py-2.5 px-4 rounded-xl hover:bg-blue-700 transition-colors text-sm mb-5"
              >
                <Download size={16} />
                Download Android App
              </a>
            ...
            {error && (
              <div className="mb-5 flex items-center gap-2 p-3 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200/60 dark:border-red-800/40">
            ...
            <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-700/50 text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <a href="/signup" className="text-blue-600 dark:text-blue-400 font-semibold hover:underline underline-offset-2">
                  Sign Up
                </a>
              </p>
            </div>
